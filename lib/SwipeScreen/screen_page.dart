  ...
  Widget build(BuildContext context) {
    ...
    return (
      ...
      child: Container(
        ...
        padding: EdgeInsets.fromLTRB(40 * fem, 110 * fem, 0 * fem, 43 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 47 * fem, 26.93 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(2 * fem, 0 * fem, 34 * fem, 27 * fem),
              width: double.infinity,
              child: Row(
            ...
            Center(
              ...
              child: Container(
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 19.5 * fem),
                width: double.infinity,
                child: Text(
                  'Grand Pasundan',
                  textAlign: TextAlign.center,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(
                        23.5 * fem, 6.5 * fem, 23.5 * fem, 7.5 * fem),
                    width: 307 * fem,
                    height: double.infinity,
                    decoration: BoxDecoration(
                      color: const Color(0xffffc58f),
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(20 * fem, 0 * fem, 29 * fem, 25 * fem),
              padding:
                  EdgeInsets.fromLTRB(36 * fem, 10.5 * fem, 93 * fem, 16 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(20 * fem, 0 * fem, 29 * fem, 59 * fem),
              padding:
                  EdgeInsets.fromLTRB(36 * fem, 10.5 * fem, 93 * fem, 16 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
